...
Revisiting the mixin creating function, a first go at such a mechanism looks
like:
...
prototype and no reference to an instance is stored by the mixin. We can fix
this by climbing up the prototype chain and checking each prototype object:
