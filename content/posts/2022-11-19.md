...
content in the file name, and serves it with immutable[^][With a long `max-age`
fallback because [Chrome doesn't support immutable][chrome immutable].] cache
headers, like the CSS mentioned above.
